  ...
  return (
    <>
      ...
      <main style={{ maxWidth: 780, margin: "0 auto", padding: "5rem 1.25rem 6rem" }}>
        ...
        <LegalSection>
          <p>
            This Cookie Policy explains what cookies and similar technologies Shopi uses, why we use them, and the choices available to you. It should be read alongside our <Link href="/privacy">Privacy Policy</Link>.
          </p>
        </LegalSection>
        ...
        <div style={{ marginTop: "3rem", paddingTop: "2rem", borderTop: "1px solid rgb(var(--color-border))", display: "flex", gap: "1.5rem", flexWrap: "wrap" }}>
          <Link href="/privacy" style={{ fontSize: "0.875rem", color: "rgb(var(--brand-primary))" }}>Privacy Policy</Link>
