    ...
    <>
      ...
      <main style={{ maxWidth: 780, margin: "0 auto", padding: "5rem 1.25rem 6rem" }}>
        ...
        <LegalSection>
          ...
          <p>
            By creating an account or using any part of the Service you confirm that you have read, understood, and agree to be bound by these Terms and our <Link href={`${base}/privacy`}>Privacy Policy</Link>. If you do not agree, do not use Shopi.
          </p>
        </LegalSection>
        ...
        <LegalSection title="7. Privacy">
          <p>
            Your use of the Service is also governed by our <Link href={`${base}/privacy`}>Privacy Policy</Link>, which is incorporated into these Terms by reference. By using Shopi you consent to our processing of your personal data as described there.
          </p>
        </LegalSection>
