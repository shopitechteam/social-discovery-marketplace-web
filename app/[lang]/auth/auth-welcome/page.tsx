  ...
  const CTAs = (
    <div className="flex flex-col gap-3">
      ...
      <p className="text-center text-xs text-placeholder leading-relaxed pt-1">
        ...
        <Link href={`/${lang}/terms`} className="text-muted underline underline-offset-2">
          Terms
        </Link>{" "}
        &{" "}
        <Link href={`/${lang}/privacy`} className="text-muted underline underline-offset-2">
          Privacy Policy
        </Link>
        .
      </p>
    ...
    <AuthDesktopShell lang={lang}>
      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-8 pb-4 pt-12">
          {/* Card stack */}
          <div className="relative w-56 h-36 mb-6">
            <div
              className="absolute left-0 top-3 w-28 rounded-2xl rotate-[-10deg] shadow-lg overflow-hidden"
              style={{
                height: 108,
                background: "linear-gradient(145deg, rgb(var(--brand-primary)), rgb(var(--brand-primary) / 0.55))",
              }}
            >
              <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent" />
              <div className="absolute top-2 left-2.5">
                <span className="text-white/70 text-[9px] font-semibold tracking-wide uppercase">Trending</span>
              </div>
              <div className="absolute bottom-2.5 left-2.5 flex items-center gap-1.5">
                ...
                <span className="text-white/80 text-[10px] font-medium">@kali</span>
              </div>
            </div>
            <div
              ...
              style={{
                height: 92,
                background: "linear-gradient(145deg, rgb(var(--brand-accent)), rgb(var(--brand-accent) / 0.55))",
              }}
            >
              <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent" />
              ...
              <div className="absolute bottom-2.5 left-2.5 flex items-center gap-1.5">
                ...
                <span className="text-white/80 text-[10px] font-medium">@marco</span>
              </div>
            </div>
            <div
              ...
              style={{
                height: 116,
                background: "linear-gradient(145deg, rgb(var(--brand-secondary)), rgb(var(--brand-secondary) / 0.65))",
              }}
            >
              <div className="absolute inset-0 bg-gradient-to-b from-white/10 to-transparent" />
              ...
              <div className="absolute bottom-2.5 left-3 flex items-center gap-1.5">
                ...
                <span className="text-white/90 text-[10px] font-semibold">@nia</span>
              </div>
            </div>
          </div>
