...
export function ShopiLogo({ className = "" }: { className?: string }) {
  return (
    <svg
    ...
    >
      ...
      {/* Icon mark — bag with discovery spark */}
      {/* Bag body */}
      <rect x="3" y="16" width="26" height="22" rx="5" fill="url(#sg)" />
      {/* Bag handle */}
      <path
        d="M10 16V13a6 6 0 0 1 12 0v3"
        stroke="url(#sg2)"
        strokeWidth="2.6"
        strokeLinecap="round"
        fill="none"
      />
      {/* Spark / discovery dot */}
      <circle cx="26" cy="12" r="5" fill="#FF9F40" />
      <path
        d="M26 9v6M23 12h6"
        stroke="white"
        strokeWidth="1.8"
...
export function ShopiLogoMark({ size = 48 }: { size?: number }) {
  return (
    ...
    >
      ...
      {/* Bag body */}
      <rect x="10" y="22" width="28" height="18" rx="4" fill="white" fillOpacity="0.92" />
      {/* Bag handle */}
      <path
