      ...
      <main style={{ maxWidth: 780, margin: "0 auto", padding: "5rem 1.25rem 6rem" }}>
        ...
        <LegalSection title="1. Information We Collect">
          ...
          <ul>
            ...
            <li><strong>Cookies and similar trackers</strong> — see our <Link href="/cookies">Cookie Policy</Link>.</li>
          </ul>
        ...
        <LegalSection title="7. Cookies">
          <p>
            We use cookies and similar technologies to operate the Service and understand usage. For full details see our <Link href="/cookies">Cookie Policy</Link>.
          </p>
        </LegalSection>
        ...
        <div style={{ marginTop: "3rem", paddingTop: "2rem", borderTop: "1px solid rgb(var(--color-border))", display: "flex", gap: "1.5rem", flexWrap: "wrap" }}>
          <Link href="/terms" style={{ fontSize: "0.875rem", color: "rgb(var(--brand-primary))" }}>Terms of Service</Link>
          <Link href="/cookies" style={{ fontSize: "0.875rem", color: "rgb(var(--brand-primary))" }}>Cookie Policy</Link>
        </div>
      </main>
    </>
  );
